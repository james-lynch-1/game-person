...
void switchRomBank(int bankNum) {
    if (MMAPARR[0x0147] == 0 || fileSize <= 32768) return;
    int i = 0;
    // use num. of banks in cartridge to mask the supplied bank num to prevent buffer overflow
    for (; i < 12; i++) {
        if (romSizeLUT[i][0] == MMAPARR[0x148])
            break;
    }
...
void write(u16 dest, u8 val) {
    ...
    switch (dest >> 12) {
        case 0: case 1: // enable RAM register
            externalRamEnabled = ((val & 0xF) == 0xA);
            break;
        case 2: case 3: // rom bank switch register
            switchRomBank(val & 0x1F);
            break;
        case 4: case 5: // ram bank switch register
            switchRamBank(val & 0b11);
            break;
        case 6: case 7: // rom bank 1
            break;
        case 8: case 9: // vram
        ...
        case 0xA: case 0xB: // a,b: external ram, if any
            if (externalRamEnabled)
                externalRam[currRamBank][dest - 0xA000] = val;
            break;
        ...
        case 0xF: // oam, io regs, high ram, interrupt enable register
            switch (dest >> 8) {
                ...
                case 0xFF: // io registers
                    ...
                    switch (dest) {
                        case 0xFF00: // input
                            MMAPARR[dest] = (oldVal & 0b11001111) | (val & 0b00110000);
                            updateInputGB();
                            break;
                        case 0xFF02: // serial
                            MMAPARR[dest] = (oldVal & 0b01111110) | (val & 0b10000001);
                            MMAPARR[0xFF01] = 0xFF;
                            handleSCWrite(val);
                            break;
                        ...
                        case 0xFF05: // TIMA
                            if (timaOverflow)
                                timaOverflow = 0;
                            else if (timaUnsettable)
                                MMAPARR[dest] = oldVal;
                            break;
                        case 0xFF06: // TMA
                            if (timaUnsettable)
                                MMAP.ioRegs.timerAndDivider.tima = val;
                            break;
                        case 0xFF07:
                        ...
                        case 0xFF2C: case 0xFF2D: case 0xFF2E: case 0xFF2F: case 0xFF4C:
                        case 0xFF4D: case 0xFF4E: case 0xFF4F: case 0xFF50: case 0xFF51:
                        case 0xFF52: case 0xFF53: case 0xFF54: case 0xFF55: case 0xFF56:
                        case 0xFF57: case 0xFF58: case 0xFF59: case 0xFF5A: case 0xFF5B:
                        case 0xFF5C: case 0xFF5D: case 0xFF5E: case 0xFF5F: case 0xFF60:
                        case 0xFF61: case 0xFF62: case 0xFF63: case 0xFF64: case 0xFF65:
                        case 0xFF66: case 0xFF67: case 0xFF68: case 0xFF69: case 0xFF6A:
                        case 0xFF6B: case 0xFF6C: case 0xFF6D: case 0xFF6E: case 0xFF6F:
                        case 0xFF70: case 0xFF71: case 0xFF72: case 0xFF73: case 0xFF74:
                        case 0xFF75: case 0xFF76: case 0xFF77: case 0xFF78: case 0xFF79:
                        case 0xFF7A: case 0xFF7B: case 0xFF7C: case 0xFF7D: case 0xFF7E:
                        case 0xFF7F:
                            MMAPARR[dest] = 0xFF;
                            break;
                            // audio
                        case 0xFF10:
                            MMAPARR[dest] = (oldVal & 0b10000000) | (val & 0b01111111);
                            break;
                        case 0xFF1A:
                            MMAPARR[dest] = (oldVal & 0b01111111) | (val & 0b10000000);
                            break;
                        case 0xFF1C:
                        ...
                        case 0xFF20:
                            ...
                            break;
                        case 0xFF23:
                            MMAPARR[dest] = (oldVal & 0b00111111) | (val & 0b11000000);
                            break;
                        case 0xFF26:
                            MMAPARR[dest] = (val & 0x80) | (oldVal & 0x7F);
                            break;
                        case 0xFF40: // LCDPROPS.LCDC
                            if (!(val & LCD_PPU_ENABLE_MASK)) { // disable ppu
                                ppu.state = mode0;
...
void dmaRead(int destAddr, int srcAddr) {
    if (srcAddr >= 0xE000 && srcAddr <= 0xFFFF)
        srcAddr -= 0x2000;
    if (srcAddr >= 0xA000 && srcAddr <= 0xBFFF) { // get the correct external RAM bank
...
void read(int destRegIndex, u16 addr) {
    ...
    bool addrInHram = addr >= 0xFF80 && addr <= 0xFFFE;
    if (addr != OAM_DMA_ADDR && cpu.dmaCycle && (cpu.dmaCycle <= 160) && !addrInHram) {
...
void add() {
    ...
    int halfCarry = (((REGARR8[REGA_IDX] & 0xF) + (REGARR8[pQ[pIndex]] & 0xF)) & 0x10) == 0x10;
...
void readRegToAF16() { // special case for AF (ignores the lower nibble of the source value)
    REGARR16[pQ[pIndex]] = REGARR16[pQ[pIndex + 1]] & 0xFFF0;
    pIndex += 2;
}
...
void readByteAndCmpBit() {
    ...
    FLAGS = ((~REGARR8[pQ[pIndex++]] & (1 << bitPos))) << (7 - bitPos) | HALFCARRY_FLAG | (FLAGS & CARRY_FLAG);
}

void readByteAndInc() { // increment the address you got it from
    read(pQ[pIndex], REGARR16[pQ[pIndex + 1]]);
...
void readMemToReg() { // dest: REGARR8 index, src: REGARR16 index holding the src addr
    read(pQ[pIndex], REGARR16[pQ[pIndex + 1]]);
    pIndex += 2;
}

void readMemAddrToReg() { // dest: REGARR8 index, src: src mem addr
    read(pQ[pIndex], pQ[pIndex + 1]);
    pIndex += 2;
}
...
void writeRegToHighMem() {
    write(0xFF00 | REGARR8[pQ[pIndex]], REGARR8[pQ[pIndex + 1]]);
}
...
void writeFlagsToMem() {
    write(REGARR16[pQ[pIndex]], (u8)REGARR8[pQ[pIndex + 1]] & 0xF0);
}
...
void writeRegToMemAndDec() {
    writeRegToMem();
    REGARR16[pQ[pIndex - 2]]--;
}

void writeRegToMemAndInc() {
    writeRegToMem();
    REGARR16[pQ[pIndex - 2]]++;
}
...
void cmpJR() {
    ...
    if (condition) {
        ...
        pIndex = 0;
        opQ[0] = jump;
        pQ[0] = cpu.regs.file.PC + (s8)offset;
    }
}
...
void rst() {
    ...
    opQ[1] = writeRegToMemAndDec; pQ[1] = REGSP_IDX; pQ[2] = REGPCHI_IDX;
    opQ[0] = writeRegToMem; pQ[3] = REGSP_IDX; pQ[4] = REGPCLO_IDX;
...
u16 getPCAndInc() {
    u16 pc = cpu.regs.file.PC++;
    cpu.regs.file.PC += cpu.repeatPC;
    cpu.repeatPC = 0;
    return pc;
}
...
void cpuTick() {
    ...
    if (cpu.dmaCycle) {
        cpu.dmaCycle--;
        if (cpu.dmaCycle <= 159)
            dmaRead(0xFE00 | (u8)0x9F - cpu.dmaCycle, (MMAPARR[OAM_DMA_ADDR] << 8) | (0x9F - cpu.dmaCycle));
    }
    if (!numISROpsQueued)
            ...
            if (!cpu.prefixedInstr)
                switch (cpu.opcode) {
                    ...
                    case 0x02: // LD [BC] A 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem; pQ[0] = REGBC_IDX; pQ[1] = REGA_IDX;
                        break;
                    ...
                    case 0x08: // LD [a16] SP 3 20 - - - -
                        ...
                        opQ[1] = writeRegToMemAndInc; pQ[4] = REGWZ_IDX; pQ[5] = REGSPLO_IDX;
                        opQ[0] = writeRegToMem; pQ[6] = REGWZ_IDX; pQ[7] = REGSPHI_IDX;
                        break;
                    ...
                    case 0x0A: // LD A [BC] 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = readMemToReg; pQ[0] = REGZ_IDX; pQ[1] = REGBC_IDX;
                    ...
                    case 0x12: // LD [DE] A 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem; pQ[0] = REGDE_IDX; pQ[1] = REGA_IDX;
                        break;
                    ...
                    case 0x1A: // LD A [DE] 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = readMemToReg; pQ[0] = REGZ_IDX; pQ[1] = REGDE_IDX;
                        miscOp = readRegToReg; pQ[2] = REGA_IDX; pQ[3] = REGZ_IDX;
                        break;
                    ...
                    case 0x22: // LD [HL+] A 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMemAndInc; pQ[0] = REGHL_IDX; pQ[1] = REGA_IDX;
                        break;
                    ...
                    case 0x32: // LD [HL-] A 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMemAndDec; pQ[0] = REGHL_IDX; pQ[1] = REGA_IDX;
                        break;
                    ...
                    case 0x34: // INC [HL] 1 12 Z 0 H -
                        numOpsQueued = 2;
                        opQ[1] = readMemToReg; pQ[0] = REGZ_IDX; pQ[1] = REGHL_IDX;
                    ...
                    case 0x36: // LD [HL] n8 2 12 - - - -
                        ...
                        opQ[0] = writeRegToMem; pQ[2] = REGHL_IDX; pQ[3] = REGZ_IDX;
                        break;
                    ...
                    case 0x46: // LD B [HL] 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = readMemToReg; pQ[0] = REGZ_IDX; pQ[1] = REGHL_IDX;
                        miscOp = readRegToReg; pQ[2] = REGB_IDX; pQ[3] = REGZ_IDX;
                        break;
                    ...
                    case 0x70: // LD [HL] B 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem; pQ[0] = REGHL_IDX; pQ[1] = REGB_IDX;
                        break;
                    case 0x71: // LD [HL] C 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem; pQ[0] = REGHL_IDX; pQ[1] = REGC_IDX;
                        break;
                    case 0x72: // LD [HL] D 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem; pQ[0] = REGHL_IDX; pQ[1] = REGD_IDX;
                        break;
                    case 0x73: // LD [HL] E 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem; pQ[0] = REGHL_IDX; pQ[1] = REGE_IDX;
                        break;
                    case 0x74: // LD [HL] H 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem; pQ[0] = REGHL_IDX; pQ[1] = REGH_IDX;
                        break;
                    case 0x75: // LD [HL] L 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem; pQ[0] = REGHL_IDX; pQ[1] = REGL_IDX;
                        break;
                    case 0x76: // HALT 1 4 - - - -
                    ...
                    case 0x77: // LD [HL] A 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToMem;
                        pQ[0] = REGHL_IDX; pQ[1] = REGA_IDX;
                        break;
                    case 0x78: // LD A B 1 4 - - - -
                        pQ[0] = REGA_IDX; pQ[1] = REGB_IDX;
                        readRegToReg();
                        break;
                    case 0x79: // LD A C 1 4 - - - -
                        pQ[0] = REGA_IDX; pQ[1] = REGC_IDX;
                        readRegToReg();
                        break;
                    case 0x7A: // LD A D 1 4 - - - -
                        pQ[0] = REGA_IDX; pQ[1] = REGD_IDX;
                        readRegToReg();
                        break;
                    case 0x7B: // LD A E 1 4 - - - -
                        pQ[0] = REGA_IDX; pQ[1] = REGE_IDX;
                        readRegToReg();
                        break;
                    case 0x7C: // LD A H 1 4 - - - -
                        pQ[0] = REGA_IDX; pQ[1] = REGH_IDX;
                        readRegToReg();
                        break;
                    case 0x7D: // LD A L 1 4 - - - -
                        pQ[0] = REGA_IDX; pQ[1] = REGL_IDX;
                        readRegToReg();
                        break;
                    ...
                    case 0xC5: // PUSH BC 1 16 - - - -
                        numOpsQueued = 3;
                        opQ[2] = decrementReg16; pQ[0] = REGSP_IDX;
                        opQ[1] = writeRegToMemAndDec; pQ[1] = REGSP_IDX; pQ[2] = REGB_IDX;
                        opQ[0] = writeRegToMem; pQ[3] = REGSP_IDX; pQ[4] = REGC_IDX;
                        break;
                    ...
                    case 0xCD: // CALL a16 3 24 - - - -
                        ...
                        opQ[1] = writeRegToMemAndDec;
                        pQ[5] = REGSP_IDX; pQ[6] = REGPCHI_IDX;
                        opQ[0] = writeRegToMem;
                        pQ[7] = REGSP_IDX; pQ[8] = REGPCLO_IDX;
                    ...
                    case 0xD5: // PUSH DE 1 16 - - - -
                        numOpsQueued = 3;
                        opQ[2] = decrementReg16; pQ[0] = REGSP_IDX;
                        opQ[1] = writeRegToMemAndDec; pQ[1] = REGSP_IDX; pQ[2] = REGD_IDX;
                        opQ[0] = writeRegToMem; pQ[3] = REGSP_IDX; pQ[4] = REGE_IDX;
                        break;
                    ...
                    case 0xDA: // JP C a16 3 16/12 - - - -
                        ...
                        readByteToReg();
                        opQ[1] = readByteToReg; pQ[2] = REGW_IDX; pQ[3] = ROMVAL;
                        opQ[0] = cmpJump; pQ[4] = (FLAGS & CARRY_FLAG) != 0; pQ[5] = (u16)((pQ[3] << 8) | pQ[1]);
                        break;
                    ...
                    case 0xDC: // CALL C a16 3 24/12 - - - -
                        ...
                        opQ[1] = readByteToReg; pQ[0] = REGZ_IDX; pQ[1] = ROMVAL;
                        opQ[0] = readByteToReg; pQ[2] = REGW_IDX; pQ[3] = ROMVAL;
                        miscOp = cmpCall; pQ[4] = (FLAGS & CARRY_FLAG) != 0; pQ[5] = (u16)(pQ[3] << 8) | pQ[1];
                        break;
                    ...
                    case 0xE0: // LDH [a8] A 2 12 - - - -
                        numOpsQueued = 2;
                        opQ[1] = readByteToReg; pQ[0] = REGZ_IDX; pQ[1] = ROMVAL;
                        opQ[0] = writeRegToHighMem;
                        pQ[2] = REGZ_IDX; pQ[3] = REGA_IDX;
                        break;
                    ...
                    case 0xE2: // LDH [C] A 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = writeRegToHighMem; pQ[0] = REGC_IDX; pQ[1] = REGA_IDX;
                        break;
                    ...
                    case 0xE5: // PUSH HL 1 16 - - - -
                        numOpsQueued = 3;
                        opQ[2] = decrementReg16; pQ[0] = REGSP_IDX;
                        opQ[1] = writeRegToMemAndDec; pQ[1] = REGSP_IDX; pQ[2] = REGH_IDX;
                        opQ[0] = writeRegToMem; pQ[3] = REGSP_IDX; pQ[4] = REGL_IDX;
                        break;
                    ...
                    case 0xEA: // LD [a16] A 3 16 - - - -
                        ...
                        opQ[2] = readByteToReg; pQ[0] = REGZ_IDX; pQ[1] = ROMVAL;
                        opQ[1] = readByteToReg; pQ[2] = REGW_IDX; pQ[3] = ROMVAL;
                        opQ[0] = writeRegToMem; pQ[4] = REGWZ_IDX; pQ[5] = REGA_IDX;
                        break;
                    ...
                    case 0xF0: // LDH A [a8] 2 12 - - - -
                        numOpsQueued = 2;
                        opQ[1] = readByteToReg; pQ[0] = REGZ_IDX; pQ[1] = ROMVAL;
                        opQ[0] = readMemAddrToReg; pQ[2] = REGZ_IDX; pQ[3] = 0xFF00 | pQ[1];
                    ...
                    case 0xF2: // LDH A [C] 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = readMemAddrToReg; pQ[0] = REGZ_IDX; pQ[1] = 0xFF00 | REGARR8[REGC_IDX];
                        miscOp = readRegToReg; pQ[2] = REGA_IDX; pQ[3] = REGZ_IDX;
                        break;
                    case 0xF3: // DI 1 4 - - - -
                        cpu.ime = false;
                    ...
                    case 0xF5: // PUSH AF 1 16 - - - -
                        numOpsQueued = 3;
                        opQ[2] = decrementReg16; pQ[0] = REGSP_IDX;
                        opQ[1] = writeRegToMemAndDec; pQ[1] = REGSP_IDX; pQ[2] = REGA_IDX;
                        opQ[0] = writeFlagsToMem; pQ[3] = REGSP_IDX; pQ[4] = REGF_IDX;
                        break;
                    ...
                    case 0xF9: // LD SP HL 1 8 - - - -
                        numOpsQueued = 1;
                        opQ[0] = readRegToReg16; pQ[0] = REGSP_IDX; pQ[1] = REGHL_IDX;
                        break;
                    case 0xFA: // LD A [a16] 3 16 - - - -
                        numOpsQueued = 3;
                        opQ[2] = readByteToReg; pQ[0] = REGZ_IDX; pQ[1] = ROMVAL;
                        opQ[1] = readByteToReg; pQ[2] = REGW_IDX; pQ[3] = ROMVAL;
                        opQ[0] = readMemAddrToReg; pQ[4] = REGZ_IDX; pQ[5] = pQ[1] | (pQ[3] << 8);
